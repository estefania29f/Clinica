<?php
   ...
   $resultado=mysqli_query($conexion, "SELECT idDoc,nombreDoc,idEsp,statusDoc FROM doctores") or
   ...
   echo "<table border=1 >";
   echo "<TR>";
   echo " <TH> Id </TH> <TH> Doctor </TH>  <TH> idEsp </TH><TH> Status </TH>  ";
   echo "</TR>";
   ...
   { 
		...
		echo "<TD>";  printf("%s",   $row["statusDoc"]);     echo "</TD>";
		echo "</TR>";	  
	} 
