<?php
   ...
   echo "<table border=1 >";
   echo "<TR>";
   echo " <TH> Id </TH> <TH> Doctor </TH>  <TH> Especialidad </TH><TH> Estado </TH><TH> Dar de baja </TH>";
   echo "</TR>";
   ...
   { 
		...
		echo "<TD>";   printf("<a href=\"deleteDoc2.php?id=%d\">Baja</a>",$row["idDoc"] ); echo "</TD>";
