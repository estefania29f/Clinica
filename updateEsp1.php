<?php
  // Variables para la conexion
   ...
   echo "<h2>Actualizar precios</h2><br>";
   echo "</font >";
   echo "<table border=1 >";
   echo "<TR>";
   echo " <TH> Id </TH> <TH> Especialidad </TH>  <TH> Precio </TH><TH> Modificar </TH>";
   echo "</TR>";
   ...
   { 
		...
		echo "<TD>";   printf("<a href=\"updateEsp2.php?id=%d\">Modificar</a>",$row["idEsp"] ); echo "</TD>";
	  	echo "</TR>";	  
	} 
