<?php
   ...
   $resultado=mysqli_query($conexion, "SELECT idDoc,nombreDoc,nombreEsp, statusDoc , costoEsp
									   FROM doctores
                                       INNER JOIN especialidades
 									   on especialidades.idEsp=doctores.idEsp") or
   ...
   echo "<table border=1 >";
   echo "<TR>";
   echo " <TH> Id </TH> <TH> Doctor </TH>  <TH> Especialidad </TH><TH> Costo </TH><TH> Estado</TH>";
   echo "</TR>";
